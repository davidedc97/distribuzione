...
angular.module('myApp.aggiungiContesto', ['ngRoute'])

.config(['$routeProvider', function($routeProvider) {
  $routeProvider.when('/aggiungiContesto', {
    templateUrl: 'aggiungiContesto/aggiungiContesto.html',
    controller: 'aggiungiContestoCtrl'
  });
}])
.controller('aggiungiContestoCtrl', function($scope, $window) {

  $scope.labelCampi = {
    aggiungiContesto: "Aggiungi contesto",
    obbligatorio: "Obbligatorio",
    codice: "Codice",
    descrizione: "Descrizione",
    campagna: "Campagna",
    tipoLavorazione: "Tipo lavorazione",
    aggiungiBtn: "Conferma",
    annullaBtn: "Annulla"
  };
